...
# ---------------------------------------------------------------- #
# Version 2.00 JFC - Calculate power consumption on each line or   #
#                    groups of lines.                              #
####################################################################
# !/usr/bin/python3.4
...
class SendReceiveThread(threading.Thread):
    # ===================================================================#
    """
	Thread to receive and send messsages through UDP socket.
	"""
    ...
    def send(self, command, dest):
        """
		Send a command to the destination.
		dest must be in the form of (IP address, port).
		"""
...
class Service:
    # ===================================================================#
    """
	This class represents a service on the PDU that can be
